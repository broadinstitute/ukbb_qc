...
def main(args):
    ...
    try:
        ...
        if args.prepare_vcf_mt:
            ...
            # REDACTED_SAMPLE_ID and REDACTED_SAMPLE_ID are both present in the 300K MT twice
            # Both versions of REDACTED_SAMPLE_ID (indices 202837 and 205124) are the same, so
            # code removes the version of the sample with a higher column index (205124)
            # REDACTED_SAMPLE_ID has column indices 81090 and 262414
